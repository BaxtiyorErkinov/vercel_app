...
const PortfolioDetail = () => {
	return (
		<div className="portfolio__detail">
			<PagesBanner page="HOME - PORTFOLIO" pagetitle="PORTFOLIO DETAILs"/>
			<div className="detailed__portfolio">
				<Grid container spacing={4}>
					<Grid item md={8} sm={6} xs={12}>
						<div className="portfolio__detail__images">
							<img src="https://meipaly-nextjs.vercel.app/_next/static/images/7-19b8774413194049f9562fa7903e6733.jpg" alt="" className="portfolio__detail__images__item"/>
							<img src="https://meipaly-nextjs.vercel.app/_next/static/images/8-e6c051b990665d27c1f86f54a5a2a903.jpg" alt="" className="portfolio__detail__images__item"/>
						</div>
					</Grid>
					<Grid item md={4} sm={6} xs={12}>
						<div className="portfolio__detail__content">
							...
							<div className="clients">
								...
								<span className="client">Jessica Brown</span>
							</div>
							<div className="category">
								<p className="title">CLIENTS</p>
								<div className="category__list">
									<span className="category">Graphic</span>
									<span className="category">,,Illustrations,,</span>
								</div>
							</div>
							<div className="date">
								<p className="title">CLIENTS</p>
								<span className="createdDate">8 Nov, 2018</span>
							</div>
